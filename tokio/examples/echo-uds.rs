...
//!
//! This server will create a Unix listener, accept connections in a loop, and
//! write back everything that's read off of each Unix connection.
//!
//! Because the Tokio runtime uses a thread pool, each Unix connection is
//! processed concurrently with all other Unix connections across multiple
//! threads.
//!
//! To see this server in action, you can run this in one terminal:
//!
//!     cargo run --example echo-uds
//
//! and in another terminal you can run:
//!
//!     socat unix-connect:/tmp/unix.socket -
//!
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // computation to happen for all items on the stream (in this case Unix
